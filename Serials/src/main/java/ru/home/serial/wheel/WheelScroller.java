...
public class WheelScroller {
    private static class AnimationHandler extends Handler {
		private final WeakReference<WheelScroller> mWheelScroller;

		public AnimationHandler(WheelScroller wheelScroller)
		{
			mWheelScroller = new WeakReference<WheelScroller>(wheelScroller);
		}
		
		@Override
		public void handleMessage(Message msg) 
		{
			WheelScroller wheelScroller = mWheelScroller.get(); 
			wheelScroller.scroller.computeScrollOffset();
            int currY = wheelScroller.scroller.getCurrY();
            int delta = wheelScroller.lastScrollY - currY;
            ...
            if (Math.abs(currY - wheelScroller.scroller.getFinalY()) < MIN_DELTA_FOR_SCROLLING) {
                currY = wheelScroller.scroller.getFinalY();
    ...
    public WheelScroller(ScrollingListener listener) {
        gestureDetector = new GestureDetector(MyApplication.getAppContext(), gestureListener);
        gestureDetector.setIsLongpressEnabled(false);
        
        scroller = new Scroller(MyApplication.getAppContext());
    ...
    public void setInterpolator(Interpolator interpolator) {
        ...
        scroller = new Scroller(MyApplication.getAppContext(), interpolator);
    }
