...
public class Serial implements Parcelable
{
    ...
    public String mReleaseStudioName;
    public String mTranslateStudioName;
    ...
    public Serial(long id, String name, String altName, int seasonsCount, int episodeWithName, int columnNumber, int isActive, String releaseStudioName, String translateStudioName, int releasedCount, int downloadedCount, int watchedCount, long minEpisodeDate, long maxEpisodeDate, long lastAction)
    {
        mId = id;
        mName = name;
        mAltName = altName;
        ...
        mIsActive = isActive;
        mReleaseStudioName = releaseStudioName;
        mTranslateStudioName = translateStudioName;
    ...
    public void writeToParcel(Parcel parcel, int i) {
        ...
        parcel.writeString(mReleaseStudioName);
        parcel.writeString(mTranslateStudioName);
    ...
    public static final Parcelable.Creator<Serial> CREATOR = new
            Parcelable.Creator<Serial>() {
				...
				public Serial createFromParcel(Parcel in) {
                    return new Serial(in.readLong(),in.readString(),in.readString(),in.readInt(),in.readInt(),in.readInt(),in.readInt(),in.readString(),in.readString(),in.readInt(),in.readInt(),in.readInt(),in.readLong(),in.readLong(),in.readLong());
                }
