...
public class MyApplication extends Application
{
    ...
    private static boolean mSelectDate;
    ...
    public static boolean isSelectDate()
    {
        return MyApplication.mSelectDate;
    }

    public static void setSelectDate(boolean isSelectDate)
    {
        MyApplication.mSelectDate = isSelectDate;
    }
    ...
    public void onCreate()
    {
        ...
        MyApplication.mSelectDate = MyApplication.mSharedPreferences.getBoolean("mSelectDate", false);
